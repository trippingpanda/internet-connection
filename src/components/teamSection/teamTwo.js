                    ...
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-10 col-lg-6">
                            ...
                            <div className="section-heading text-center">
                                ...
                                <p className="text-white d-none d-sm-block mt-4">{this.state.initData.headingText}</p>
                                <p className="text-white d-block d-sm-none mt-4">{this.state.initData.headingTextTwo}</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                                ...
                                return(
                                    <div key={`to_${idx}`} className="single-team text-center px-3 py-2 m-2">
                                        ...
                                        <div className="team-content mt-2 mb-1">
                                            <h3 className="team-name text-white mt-3 mb-2">{item.name}</h3>
                                            <h5 className="team-post text-white mb-2">{item.position}</h5>
                                            <p className="team-description text-white">{item.text}</p>
                                            {/* Team Media */}
