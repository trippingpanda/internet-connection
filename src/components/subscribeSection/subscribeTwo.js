...
class subscribeTwo extends Component {
    state = {
        initData: {}
    }
    componentDidMount(){
                ...
                <div className="container">
                    ...
                    <div className="start-free-content d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between shadow-lg" data-aos="fade-up">
                        ...
                        <div className="start-free-text">
                            <h2 className="text-white mb-2">{this.state.initData.heading}</h2>
                            <span className="text-white">{this.state.initData.content}</span>
                        </div>
                        {/* Start Free Button */}
