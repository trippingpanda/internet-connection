                        ...
                        <div className="col-12 col-md-6 col-lg-6">
                            <div className="features-text">
                                ...
                                <div className="headings d-flex align-items-center mb-4">
                                    <span className="text-uppercase text-white d-none d-sm-block">{this.state.data.headingSpan}</span>
                                    <h2 className="text-white text-capitalize">{this.state.data.heading}</h2>
                                </div>
                                <p className="text-white my-3">{this.state.data.headingText}</p>
                                {/* Counter List */}
                                <CounterSection />
                            </div>
                        </div>
                                        ...
                                        return(
                                            <li key={`ft_${idx}`}>
                                                ...
                                                <div className="single-features media p-3">
                                                    {/* Features Title */}
                                                    <div className="features-title text-white mr-3">
                                                        <img src={item.featureImage} alt="" />
                                                    </div>
                                                    {/* Features Text */}
                                                    <div className="features-text media-body">
                                                        <h3 className="text-white">{item.featuretitle}</h3>
                                                        <p className="text-white">{item.featureText}</p>
                                                    </div>
                                                </div>
                                            </li>
                                        );
